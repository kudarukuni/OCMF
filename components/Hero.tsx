      ...
      <Container maxW={'2xl'}>
        ...
        >
          ...
          >
            Review movies 🍿 <br />
            on{' '}
            <Text as={'span'} color={useColorModeValue('#E73434', '#FACB47')}>
              {' '}
              Blockchain
            </Text>
          </Heading>
          ...
          >
            <Button
              ...
              bg={useColorModeValue('#E73434', '#FACB47')}
              color={useColorModeValue('white', 'black')}
              rounded={'full'}
              px={6}
              _hover={{
                bg: useColorModeValue('#EF1818', '#E2A940'),
              }}
            >
              Review a movie
            </Button>
            <Button
              variant={'link'}
              color={useColorModeValue('#E73434', '#FACB47')}
              size={'sm'}
            >
              Learn more
            </Button>
